var _azerionBuildVersion = "tc-33";
var _azerionIntegration = {
  gdId: "9c198ab7ea604815b9be974df1eb5841",
  rtgEnabled: false,
  lbEnabled: false,
  fbType: "dummy",
  alxType: "none",
  ...
  gmoEnabled: false,
  splashEnabled: false,
  gameTitle: "Bubble Shooter Butterfly Witch Tower",
};
var playBtn = true;
var fbrqBD = 0;
var fbrqLA = true;
...
(() => {
  var i = {
      34: (e) => {
        ...
        function o(e, t, n, i, o) {
          ...
          (n = new r(n, i || e, o)), (i = p ? p + t : t);
          return (
            e._events[i]
              ? e._events[i].fn
                ? (e._events[i] = [e._events[i], n])
                : e._events[i].push(n)
              : ((e._events[i] = n), e._eventsCount++),
            e
          );
        }
        function l(e, t) {
        ...
        Object.create &&
          ...
          (t.prototype.listeners = function (e) {
            ...
            if (!t) return [];
            if (t.fn) return [t.fn];
            for (var n = 0, i = t.length, o = new Array(i); n < i; n++)
              o[n] = t[n].fn;
            return o;
          }),
          ...
          (t.prototype.emit = function (e, t, n, i, o, r) {
            var a = p ? p + e : e;
            ...
            if (l.fn) {
              switch ((l.once && this.removeListener(e, l.fn, void 0, !0), d)) {
                ...
                case 6:
                  return l.fn.call(l.context, t, n, i, o, r), !0;
              }
              for (h = 1, s = new Array(d - 1); h < d; h++)
                s[h - 1] = arguments[h];
            ...
            if (this._events[e])
              if (t) {
                ...
                if (o.fn)
                  ...
                  for (var r = 0, a = [], s = o.length; r < s; r++)
                    (o[r].fn !== t ||
                      (i && !o[r].once) ||
                      (n && o[r].context !== n)) &&
                      a.push(o[r]);
                  a.length
                    ? (this._events[e] = 1 === a.length ? a[0] : a)
                    : l(this, e);
                }
              } else l(this, e);
            return this;
          ...
          (t.prototype.removeAllListeners = function (e) {
            return (
              e
                ? ((e = p ? p + e : e), this._events[e] && l(this, e))
                : ((this._events = new n()), (this._eventsCount = 0)),
              this
            );
          }),
      ...
      470: (e, t, n) => {
        (n = [n, t, n(12)]),
          (t = function (e, t, n) {
            function i() {
              (this.adsEnabled = !1), (this.loadComplete = !1);
            }
            Object.defineProperty(t, "__esModule", {
              value: !0,
            }),
              ...
              (i.prototype.setManager = function (e) {
                (this.adManager = e),
                  (this.jioGamesSP =
                    null == (e = window._azerionJGSDK) ? void 0 : e.JioGamesSP);
              }),
              (i.prototype.showAd = function (e) {
                e === n.AdType.interstitial
                  ? this.jioGamesSP.showAdMidRoll()
                  : e === n.AdType.rewarded && this.jioGamesSP.showAdRewarded(),
                  this.resumeGameplay();
              }),
              ...
              (i.prototype.adAvailable = function (e) {
                return e === n.AdType.interstitial
                  ? this.jioGamesSP.isMidrollAdAvailable()
                  : e === n.AdType.rewarded &&
                      this.jioGamesSP.isRewardedAdAvailable();
              }),
              (t.JioAdProvider = i);
          }.apply(t, n));
        void 0 !== t && (e.exports = t);
        ...
        (n = [n, t, n(12)]),
          (t = function (e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
              ...
              (i.prototype.sdkLoaded = function () {
                (this.adsEnabled = !0),
                  (this.loadComplete = !0),
                  this.adManager.emit(n.AdEvents.AD_PROVIDER_LOADED);
              }),
              (i.prototype.showAd = function (e) {
                void 0 === e && (e = n.AdType.interstitial),
                  this.resumeGameplay();
          ...
          (t = function (e, t, i) {
            ...
            Object.defineProperty(t, "__esModule", {
              ...
              (n.prototype.loadBanner = function () {
                ...
                return (
                  console.log("[Dummy]:Banner Available =>", 0 === n),
        ...
        (n = [n, t, n(12), n(592)]),
          (t = function (e, t, i, n) {
            ...
            Object.defineProperty(t, "__esModule", {
              ...
              (o.prototype.sdkLoaded = function () {
                console.log("[Dummy]: SDK Loaded"),
                  (this.loadComplete = !0),
                  (this.adsEnabled = !0),
                  this.adManager.emit(i.AdEvents.AD_PROVIDER_LOADED);
              }),
              (o.prototype.showAd = function (e) {
                var t = this,
                  n =
                    (void 0 === e && (e = i.AdType.interstitial),
                    console.log(
                      "[Dummy]: Ad type requested = ",
                      e === i.AdType.interstitial ? "interstitial" : "rewarded"
                    ),
                ...
                console.log("[Dummy]:Ad Available =>", 0 === n),
                  1 === n
                    ...
                    : (e === i.AdType.rewarded &&
                        setTimeout(function () {
                          console.log(
                            "[Dummy]: Reward Claimed for rewarded ad"
                          ),
              ...
              (o.prototype.resumeGameplay = function () {
                this.adManager.emit(i.AdEvents.CONTENT_RESUMED);
              }),
              (o.prototype.preloadAd = function (e) {
                void 0 === e && i.AdType.interstitial;
              }),
              (o.prototype.destroyAd = function () {}),
              (o.prototype.hideAd = function () {}),
              (o.prototype.adAvailable = function (e) {
                return !0;
              }),
              (o.prototype.getBanner = function (e) {
          ...
          (t = function (e, t, o, n) {
            ...
            function a(e) {
              ...
              if (
                ...
                throw new Error(
                  "Valid game id is not provided for GD Ad provider"
                );
              window.GD_OPTIONS = {
                gameId: e,
                ...
                onEvent: function (e) {
                  switch (e.name) {
                    ...
                    case "SDK_REWARDED_WATCH_COMPLETE":
                      i.adManager.emit(o.AdEvents.AD_REWARDED),
                        (i.hasRewarded = !1);
                      break;
                    case "AD_ERROR":
            ...
            Object.defineProperty(t, "__esModule", {
              ...
              ((r = i =
                t.GameDistributionAdType ||
                (t.GameDistributionAdType = {})).interstitial = "interstitial"),
              (r.rewarded = "rewarded"),
              (r.display = "display"),
              ...
              (a.prototype.sdkLoaded = function () {
                (this.adsEnabled = !0),
                  (this.loadComplete = !0),
                  this.adManager.emit(o.AdEvents.AD_PROVIDER_LOADED);
              }),
              (a.prototype.showAd = function (t) {
                var n = this;
                // this.adsEnabled ? void 0 ===window.wsdk ||window.wsdk && void 0 ===window.wsdk.showAd ? (this.adsEnabled = !1,
                // this.adManager.emit(o.AdEvents.CONTENT_RESUMED)) :
                n.adManager.emit(o.AdEvents.CONTENT_PAUSED);
                window.wsdk
                  .showAd(t === o.AdType.rewarded ? i.rewarded : i.interstitial)
                  .then(function (e) {
                    t === o.AdType.rewarded &&
                      n.hasRewarded &&
                      (n.hasRewarded = !0),
                      (this.adsEnabled = !0);
                    wsdk.adover.rewarded = true;
                    n.adManager.emit(o.AdEvents.CONTENT_RESUMED);
                  })
                  .catch(function (e) {
                    t === o.AdType.rewarded &&
                      n.hasRewarded &&
              ...
              (a.prototype.preloadAd = function (e) {
                var t = this;
                // !this.hasRewarded && this.adsEnabled && e === o.AdType.rewarded && (console.log("preloading ad"),
                // t.hasRewarded = !0,
                t.adManager.emit(o.AdEvents.AD_LOADED, e);
                //    window.wsdk.preloadAd(i.rewarded).then(function() {
                //     })
                // )
              }),
              (a.prototype.adAvailable = function (e) {
                return e !== o.AdType.rewarded || this.hasRewarded;
              }),
              (a.prototype.destroyAd = function () {}),
              (a.prototype.hideAd = function () {}),
              (a.prototype.getBanner = function (e) {
                return this.adsEnabled
                  ? ((e = new n.GameDistributionBanner(e))
                      .loadBanner()
                      .catch(function () {
          ...
          (t = function (e, t, n, i) {
            ...
            Object.defineProperty(t, "__esModule", {
              ...
              (o.prototype.loadBanner = function () {
                return void 0 === window.wsdk
                  ? Promise.reject(
                      "GD Sdk not available, probably due to adblocker"
                    )
                  : window.wsdk.showAd(n.GameDistributionAdType.display, {
              ...
              (o.prototype.alignIn = function (e) {
                var t = this;
                this.parent
              ...
              (o.prototype.setOffset = function (e, t) {
                void 0 === t && (t = 0),
                ...
                if (this.parent) {
                  ...
                  switch (this.alignment) {
                    ...
                    case i.GameDistributionAlignment.TopRight:
                      this.position(
                        e.left + e.width - this.width * this.scaleFactor,
                        e.top
                      );
                      break;
                    ...
                    case i.GameDistributionAlignment.BottomLeft:
                      this.position(
                        e.left,
                        e.top + e.height - this.height * this.scaleFactor
                      );
                      break;
              ...
              (o.prototype.setSize = function (e) {
                ...
                switch (e) {
                  ...
                  case i.GameDistributionBannerSize.WideSkyscraper:
                    (t = 160), (n = 600);
                    break;
                  case i.GameDistributionBannerSize.MobileMediumRectangleOne:
                    (t = 300), (n = 50);
                    break;
                  case i.GameDistributionBannerSize.MobileMediumRectangleTwo:
                    (t = 320), (n = 50);
                }
                (this.width = t),
                  (this.height = n),
          ...
          (t = function (e, t, i) {
            function n(e) {
              ...
              (this.adsEnabled = !1),
                ...
                n.getElementById(t) ||
                  ((n = n.createElement("script")).addEventListener(
                    "load",
                    function () {
                      o.initialize();
                    }
              ...
              (n.prototype.showAd = function (e) {
                ...
                void 0 === e && (e = i.AdType.interstitial),
                  this.adsEnabled && window.hasOwnProperty("_YaSDK")
                    ? (e === i.AdType.interstitial &&
                        null !=
                          (t = null == (t = window._YaSDK) ? void 0 : t.adv) &&
                        t.adOpened) ||
                      (e === i.AdType.rewarded
                        ? null !=
                            (t =
                              null ==
                              (e = null == (t = window._YaSDK) ? void 0 : t.adv)
                                ? void 0
                                : e.showRewardedVideo) &&
                          t.call(e, {
                            callbacks: {
      ...
      563: (e, t, n) => {
        (n = [n, t, n(110), n(670), n(474), n(444), n(654)]),
          (t = function (e, t, n, i, o, r, a) {
            Object.defineProperty(t, "__esModule", {
              value: !0,
            }),
              (t.YandexAdProvider =
                t.GameDistributionBanner =
                t.GameDistribution =
                t.DummyProvider =
      ...
      260: (e, t, n) => {
        n = function (e, t) {
          ...
          Object.defineProperty(t, "__esModule", {
            ...
            ((n = t.DummyBannerSize || (t.DummyBannerSize = {}))[
              (n.LargeRectangle = 0)
            ] = "LargeRectangle"),
            ...
            ((n = t.DummyAlignment || (t.DummyAlignment = {}))[
              (n.TopLeft = 0)
            ] = "TopLeft"),
      ...
      869: (e, t, n) => {
        n = function (e, t) {
          ...
          Object.defineProperty(t, "__esModule", {
            ...
            (t.GameDistributionAlignment = t.GameDistributionBannerSize =
              void 0),
            ((n =
              t.GameDistributionBannerSize ||
              (t.GameDistributionBannerSize = {}))[(n.LargeRectangle = 0)] =
              "LargeRectangle"),
            (n[(n.MediumRectangle = 1)] = "MediumRectangle"),
            (n[(n.Billboard = 2)] = "Billboard"),
            (n[(n.Leaderboard = 3)] = "Leaderboard"),
            (n[(n.Skyscraper = 4)] = "Skyscraper"),
            (n[(n.WideSkyscraper = 5)] = "WideSkyscraper"),
            (n[(n.MobileMediumRectangleOne = 6)] = "MobileMediumRectangleOne"),
            (n[(n.MobileMediumRectangleTwo = 7)] = "MobileMediumRectangleTwo"),
            ((n =
              t.GameDistributionAlignment ||
              (t.GameDistributionAlignment = {}))[(n.TopLeft = 0)] = "TopLeft"),
            (n[(n.TopCenter = 1)] = "TopCenter"),
            (n[(n.TopRight = 2)] = "TopRight"),
            (n[(n.CenterLeft = 3)] = "CenterLeft"),
            (n[(n.Center = 4)] = "Center"),
      ...
      12: (e, t, n) => {
        n = function (e, t) {
          ...
          Object.defineProperty(t, "__esModule", {
            ...
            ((n = t.AdEvents || (t.AdEvents = {})).CONTENT_PAUSED =
              "onContentPaused"),
            ...
            ((n = t.AdType || (t.AdType = {}))[(n.interstitial = 0)] =
              "interstitial"),
      ...
      548: function (e, t, n) {
        var i,
          ...
          t = function (e, t, n, i, o, r) {
            var a;
            function s(e, t) {
              var n = a.call(this) || this;
              switch (((n.bannerActive = !1), (n.provider = null), e)) {
                case i.ProviderTypes.AdFree:
                  n.provider = new o.AdFreeUntrackedProvider();
                  break;
                case i.ProviderTypes.Dummy:
                  n.provider = new o.DummyProvider();
                  break;
                case i.ProviderTypes.Yandex:
                  n.provider = new o.YandexAdProvider();
                  break;
                case i.ProviderTypes.Jio:
                  n.provider = new r.JioAdProvider();
                  break;
                default:
                case i.ProviderTypes.GD:
                  n.provider = new o.GameDistribution(t);
              }
            ...
            Object.defineProperty(t, "__esModule", {
              ...
              (s.prototype.getBanner = function () {
                ...
                if (null === this.provider)
                  throw new Error(
                    "Can not load a banner without an provider, please attach an ad provider!"
                  );
                return "function" == typeof this.provider.getBanner
                  ? this.provider.getBanner.apply(this.provider, e)
                  : null;
              }),
              ...
              (s.prototype.hideAd = function (e) {
                ...
                if (null === this.provider)
                  throw new Error(
                    "Can not hide an ad without an provider, please attach an ad provider!"
                  );
              ...
              (s.prototype.isLoadComplete = function () {
                if (null === this.provider)
                  throw new Error(
                    "Can not confirm load complete without an provider, please attach an ad provider!"
                  );
  ...
  ((e, t) => {
      ...
      : t(
          ((e =
            "undefined" != typeof globalThis
              ? globalThis
              : e || self).h5branding = e.h5branding || {})
        );
  })(this, function (r) {
    var z =
      "undefined" != typeof globalThis
    ...
    e(function (e, I) {
      ...
      function g(e, t) {
        e._state === C && ((e._state = B), (e._result = t), D(n, e));
      }
      function a(e, t, n, i) {
      ...
      function s(e) {
        var t = e._subscribers,
          n = e._state;
        if (0 !== t.length) {
          for (var i, o = void 0, r = e._result, a = 0; a < t.length; a += 3)
            (i = t[a]), (o = t[a + n]), i ? m(n, i, o, r) : o(r);
      ...
      var v, b, _, A, D, x, S, T, k, E, O, C, P, B, L, M, R;
      e.exports =
        ((v =
          Array.isArray ||
          function (e) {
        ...
        (A = _ = void (b = 0)),
        (D = function (e, t) {
          (k[b] = e), (k[b + 1] = t), 2 === (b += 2) && (A ? A(i) : E());
        }),
        (e = "undefined" != typeof window ? window : void 0),
        (S = (x = e || {}).MutationObserver || x.WebKitMutationObserver),
        (x =
          "undefined" == typeof self &&
          ...
          : (S
              ...
              ? function () {
                  try {
                    ...
                    return void 0 !== (_ = e.runOnLoop || e.runOnContext)
                      ? function () {
                          _(i);
                        }
                      : t();
        ...
        (o.prototype._settledAt = function (e, t, n) {
          var i = this.promise;
          i._state === C &&
            (this._remaining--, e === B ? g(i, n) : (this._result[t] = n)),
      ...
      (t.has = function (e) {
        ...
        return (
          !(
            i <= 0 ||
            i >= e.length - 1 ||
            (t = e.lastIndexOf(".", i - 1)) <= 0 ||
            i - 1 <= t ||
            !(n = o[e.slice(i + 1)])
          ) && 0 <= n.indexOf(" " + e.slice(t + 1, i) + " ")
        );
      }),
      (t.is = function (e) {
        var t,
    ...
    (a.setList = function (e) {
      ...
      (a.getDomain = function (e) {
        var t;
        return o
          ? (t = e.match(/\./g)) && t.length < 2
            ? e
            : (t = this.getTld(e))
            ? ((t = e.length - t.length - 1),
    ...
    Object.defineProperty(d, "instance", {
      get: function () {
        return (d.classInstance =
          void 0 === d.classInstance ? new d() : d.classInstance);
      },
      enumerable: !1,
      configurable: !0,
    }),
      ...
      (d.prototype.loadComplete = function (e, t) {
        if (!this.contains(e))
          return Promise.reject(
            "Item was removed from cache before loading was complete."
          );
        try {
          var n = JSON.parse(t);
      ...
      (d.prototype.loadScript = function (i, e, o) {
      ...
      (d.prototype.requestXhr = function (n, i) {
        ...
        return (
          ...
          window.XMLHttpRequest
            ? ((o = new XMLHttpRequest()),
              new Promise(function (e, t) {
                o.onreadystatechange = function () {
                  4 === o.readyState &&
                    (200 === o.status
                      ? (e(o.responseText), (o.onreadystatechange = null))
                      : 0 < o.status &&
                        (t(
                          "There was a problem with the request: status ".concat(
                            o.status
                          )
                        ),
            ...
            : Promise.reject(
                "Unable to send request, XMLHttpRequest not supported."
              )
        );
      });
    var s = d;
    ...
    (r.BrandingDomain = void 0),
      ((E = r.BrandingDomain || (r.BrandingDomain = {}))[(E.Neutral = 0)] =
        "Neutral"),
      (E[(E.Yepi = 1)] = "Yepi"),
      (E[(E.Spele = 2)] = "Spele"),
      ...
      (p.isBip = function () {
        return (
          -1 !== window.location.search.indexOf("bipgaming") ||
          "bip.fbrq.io" === window.location.host
        );
      }),
      ...
      (p.isBild = function () {
        return (
          "bild.fbrq.io" === window.location.host ||
          -1 !== window.location.host.indexOf("contentfleet.com")
        );
      }),
      (p.isYandex = function () {
        return (
          window.hasOwnProperty("_YaSDK") || window.hasOwnProperty("YaGames")
        );
      }),
        ...
        return null !=
          (e =
            null == (e = window.YandexGamesSDKEnvironment)
              ...
              : e.browser) &&
          e.lang &&
          "en" === window.YandexGamesSDKEnvironment.browser.lang
          ? "yandex.com"
          : "yandex.ru";
      }),
      ...
      (p.isSpecificPartner = function (e, t, n) {
        var i = !1;
        try {
          var o = new URLSearchParams(e).get(t);
          o && -1 !== o.indexOf(n) && (i = !0);
        } catch (e) {
    ...
    function p() {}
    (r.UtmTargets = void 0),
      ((E = r.UtmTargets || (r.UtmTargets = {}))[(E.splashscreen = 0)] =
        "splashscreen"),
      (E[(E.logo = 1)] = "logo"),
      (E[(E.facebook = 2)] = "facebook"),
      (E[(E.twitter = 3)] = "twitter"),
      (E[(E.playstore = 4)] = "playstore"),
      (E[(E.appstore = 5)] = "appstore"),
      (E[(E.more_games = 6)] = "more_games"),
      (E[(E.download_game = 7)] = "download_game"),
      (E[(E.walkthrough = 8)] = "walkthrough"),
      (E[(E.disclaimer = 9)] = "disclaimer"),
      (E[(E.highscores = 10)] = "highscores"),
      (g.getProtocol = function (e) {
        return e ? "https://" : "//";
      }),
      (g.getUtmContent = function (e) {
        return "string" == typeof e ? e : r.UtmTargets[e];
      }),
      ...
      (g.getPromoURL = function (e, t, n, i, o) {
        return window.hasOwnProperty("_YaSDK") ||
          window.hasOwnProperty("YaGames")
          ? "https://".concat(
              h.getYandexBaseURL(),
              "/games/developer?name=Azerion"
            )
          : e === r.BrandingDomain.Admeen
          ? "https://media.admeen.com/branding/link.php"
          : e === r.BrandingDomain.Bild
          ? t
          : t +
            "/?utm_source=" +
            n +
    ...
    w.loadPortalScript = function (e) {
      e &&
        e.hasOwnProperty("minijuegos") &&
        -1 !== e.minijuegos.indexOf(D.getSourceSite()) &&
        (void 0 !== window.mpConfig
        ...
        e &&
          e.hasOwnProperty("kongregate") &&
          -1 !== e.kongregate.indexOf(D.getSourceSite()) &&
          m(
        ...
        e &&
          e.hasOwnProperty("newgrounds") &&
          -1 !== e.newgrounds.indexOf(D.getSourceSite()) &&
          m(
            "https://cdn.fbrq.io/@azerion/splash/assets/scripts/newgroundsio.min.js",
            Date.now() / 1e3
          );
    };
    var y = w;
    ...
    (b.isStandAlone = function () {
      var e;
      return null != (e = window._azerionIntegration) && e.sa
        ? null == (e = window._azerionIntegration)
          ? void 0
          : e.sa
        : !!window.hasOwnProperty("fbrqSA") && window.fbrqSA;
    }),
      (b.hasDomainForCustomBuild = function () {
        var e;
        return (
          (null == (e = window._azerionIntegration) ? void 0 : e.bd) ||
          window.hasOwnProperty("fbrqBD")
        );
      }),
      (b.getDomainForCustomBuild = function () {
        var e;
        return null != (e = window._azerionIntegration) &&
          e.bd &&
          (null == (e = window._azerionIntegration) ? void 0 : e.bd) in
            r.BrandingDomain
          ? null == (e = window._azerionIntegration)
            ? void 0
            : e.bd
          : window.hasOwnProperty("fbrqBD") && window.fbrqBD in r.BrandingDomain
          ? window.fbrqBD
          : void 0;
      }),
      (b.hasLinksSettingsForCustomBuild = function () {
        var e;
        return (
          (null == (e = window._azerionIntegration) ? void 0 : e.la) ||
          window.hasOwnProperty("fbrqLA")
        );
      }),
      (b.getLinkSettingsForCustomBuild = function () {
        var e;
        return null != (e = window._azerionIntegration) && e.la
          ? null == (e = window._azerionIntegration)
            ? void 0
            : e.la
          : window.hasOwnProperty("fbrqLA")
    ...
    (A.preload = function (e) {
      var t = Promise.all([
        s.instance.load(
          i.KEY,
          "".concat(D.ASSET_LOCATION, "json/domains.json?v=").concat(e),
          "text/plain"
        ),
        s.instance.load(
          A.SITELOCK_PORTALS,
          "".concat(D.ASSET_LOCATION, "json/sitelock.json?v=").concat(e),
          "text/plain"
        ),
      ]);
      return (
        Promise.all([
          s.instance.load(
            A.INTERNAL_PORTALS_KEY,
            "".concat(D.ASSET_LOCATION, "json/internal.json?v=").concat(e),
            "text/plain"
          ),
          s.instance.load(
            A.CONTRACTED_PORTALS_KEY,
            "".concat(D.ASSET_LOCATION, "json/contracted.json?v=").concat(e),
            "text/plain"
          ),
          s.instance.load(
            A.SPECIAL_PORTALS_KEY,
            "".concat(D.ASSET_LOCATION, "json/special.json?v=").concat(e),
            "text/plain"
          ),
        ]),
        t
      ...
      Object.defineProperty(A, "brandingLogoUrl", {
        get: function () {
          var e;
          switch (
            (D.isOnDevice() || h.isAirfi()
              ? (D.ASSET_LOCATION = "assets/")
              : "fbrq.io" === D.getSourceSite(!0) &&
                (D.ASSET_LOCATION =
                  "https://" +
                  window.location.host +
                  "/@azerion/splash/assets/"),
            D.getBrandingDomain())
          ) {
            case r.BrandingDomain.Spele:
              e = "spele";
          ...
          return D.ASSET_LOCATION + "images/branding_logo_" + e + "_small.png";
        },
        enumerable: !1,
        configurable: !0,
      }),
      ...
      (A.createCampaignURL = function (e, t) {
        var n = D.getSourceSite(),
          ...
          o = f.getProtocol(D.isOnDevice()),
          o = f.getDomainURL(i, o),
          t = f.getUtmContent(t);
        return f.getPromoURL(i, o, n, e, t);
      }),
      ...
      (A.isAdmeen = function () {
        var e;
        return (
          !(!A.siteLocks || !A.siteLocks.hasOwnProperty("admeen")) &&
          ((e = A.siteLocks.admeen), A.hostMatchesList(e))
        );
      }),
      (A.isKongregate = function () {
        var e;
        return (
          !(!A.siteLocks || !A.siteLocks.hasOwnProperty("kongregate")) &&
          ((e = A.siteLocks.kongregate), A.hostMatchesList(e))
        );
      }),
      (A.isNewgrounds = function () {
        var e;
        return (
          !(!A.siteLocks || !A.siteLocks.hasOwnProperty("newgrounds")) &&
          ((e = A.siteLocks.newgrounds), A.hostMatchesList(e))
        );
      }),
      ...
      (A.outGoingLinksAllowed = function () {
        return (
          !(h.isAirfi() || A.isSpecial() || A.isContracted()) &&
          (!v.hasLinksSettingsForCustomBuild() ||
            v.getLinkSettingsForCustomBuild())
        );
      }),
      (A.hostMatchesList = function (e) {
        e = e || [];
        for (var t = D.getSourceSite(), n = 0; n < e.length; n++)
          if (t === e[n]) return !0;
        return !1;
      }),
    ...
    (x.loadHost = function () {
      return c(this, void 0, void 0, function () {
        ...
        return u(this, function (e) {
          switch (e.label) {
            case 0:
              if (
                ((t = document.referrer || window.location.host),
                !window.hasOwnProperty("gdsdk"))
              )
                return [3, 4];
              e.label = 1;
            case 1:
              return e.trys.push([1, 3, , 4]), [4, window.wsdk.getSession()];
            case 2:
      ...
      (x.getSourceSite = function (e) {
        var t = x.HOST;
        return (
          -1 !==
            (t = (e = void 0 !== e && e) ? window.location.host : t).indexOf(
              "embed.gamedistribution.com"
            ) &&
            -1 !== window.location.search.indexOf("gd_sdk_referrer_url") &&
            (t = x.getUrlParameter("gd_sdk_referrer_url") || t),
      ...
      (x.getBrandingDomain = function () {
        ...
        var e = x.getSourceSite();
        if (_.isAdmeen()) return r.BrandingDomain.Admeen;
        if (h.isPlaycellApp() || h.isBip()) return r.BrandingDomain.PlayCell;
        switch (e) {
          case "spele.nl":
      ...
      (x.isOnDevice = function () {
        return (
          ...
          !/(gamedistribution\.com)/.test(window.location.hostname)
        );
      }),
      (x.isTc = function () {
        return /(teamcity\.azerdev\.com)/.test(window.location.host);
      }),
      (x.getRandomRange = function (e, t) {
        return (Math.random() * (t - e) + e) | 0;
      }),
      (x.getUrlParameter = function (e) {
        e = e.replace(/[\[]/, "\\[").replace(/[\]]/, "\\]");
        e = new RegExp("[\\?&]" + e + "=([^&#]*)").exec(location.search);
        return null === e ? "" : decodeURIComponent(e[1].replace(/\+/g, " "));
      }),
      (x.intTimeToString = function (e) {
      ...
      (x.ASSET_LOCATION = v.isStandAlone()
        ? "assets/"
    ...
    (T.getUrlParams = function (e, t) {
      ...
      (T.showBuildInfo = function (e) {
        ...
        (T.search = e),
          T.enableDebugMode() &&
            T.showVersioning() &&
            (((e = document.createElement("div")).id = "az-debug-box"),
            ...
            (n.textContent = "Build creation date:: ".concat(
              new Date(t.build.timeStamp).toDateString()
            )),
            e.appendChild(n),
    ...
    var k = e(function (e, t) {
        e.exports = (function n(i, o, r) {
          ...
          for (var s = l, e = 0; e < r.length; e++) a(r[e]);
          return a;
        })(
          {
            1: [
                ...
                !function () {
                  var c,
                    ...
                    v =
                      ...
                      (O.prototype.setConfig = function (e) {
                        ...
                        return (
                          D(i, n),
                          (this._easing = E(n, e.easing || "linear")),
                          (this._filterArgs = [
                            n,
                            this._originalState,
                            i,
                      ...
                      (O.prototype.seek = function (e) {
                        ...
                        return (
                          this._timestamp + e === 0 ||
                            ((this._timestamp = t - e), this.isPlaying()) ||
                            ((this._isTweening = !0),
                            (this._isPaused = !1),
                            k(
                              this,
                      ...
                      "object" == typeof G
                        ? (j.exports = O)
                        : void 0 === w.Tweenable && (w.Tweenable = O),
                      O);
                  function b() {}
                  function _(e, t) {
                  ...
                  function T(t, n) {
                    var i = O.prototype.filter,
                      o = t._filterArgs;
                    _(i, function (e) {
                      void 0 !== i[e][n] && i[e][n].apply(t, o);
                    });
                  }
                  function k(e, t, n, i, o, r, a, s, l, d, c) {
                    (p = t + n + i),
                      (u = Math.min(c || f(), p)),
                      (h = p <= u),
                      (p = i - (p - u)),
                      e.isPlaying() &&
                        (h
                          ? (l(a, e._attachment, p), e.stop(!0))
                          : ((e._scheduleId = d(e._timeoutHandler, 1e3 / 60)),
                            T(e, "beforeTween"),
                            u < t + n
                              ? x(1, o, r, a, 1, 1, s)
                              : x(u, o, r, a, i, t + n, s),
                  ...
                  function L(o, r) {
                    d.each(r, function (e) {
                      for (var t = R(o[e]), n = t.length, i = 0; i < n; i++)
                        o[r[e].chunkNames[i]] = +t[i];
                      delete o[e];
                    });
                  }
                  function M(n, i) {
                    d.each(i, function (e) {
                      ...
                      var t = ((e, t) => {
                          ...
                          ((e, t) => {
                            for (var n, i = {}, o = t.length, r = 0; r < o; r++)
                              (i[(n = t[r])] = e[n]), delete e[n];
                            return i;
                          })(n, i[e].chunkNames),
                          i[e].chunkNames
                        ),
                        t = ((e, t) => {
                          for (var n = e, i = t.length, o = 0; o < i; o++)
                            n = n.replace(m, +t[o].toFixed(4));
                          return n;
                        })(i[e].formatString, t);
                      n[e] = B(o, t, z);
                    });
                  ...
                  v.shallowCopy(v.prototype.formula, {
                    ...
                    (v.setBezierFunction = function (e, t, n, i, o) {
                      function r(e) {
                        return (
                          (c =
                            (o = 1) -
                          ...
                          (((1 - (n = 3 * s) - (t = 3 * ((i = f) - s) - n)) *
                            (i = ((e, t) => {
                              for (var n, i, o, r, a = e, s = 0; s < 8; s++) {
                                if (d((o = l(a) - e)) < t) return a;
                                if (d((r = (3 * c * a + 2 * u) * a + h)) < 1e-6)
                                  break;
                                a -= o / r;
                              }
                              if ((a = e) < (n = 0)) return n;
                    ...
                    ((s = new v())._filterArgs = []),
                    (v.interpolate = function (e, t, n, i, o) {
                      var r = v.shallowCopy({}, e),
                        o = o || 0,
                    ...
                    (d.prototype.filter.token = {
                      ...
                      beforeTween: function (e, t, n, i) {
                        ...
                        d.each(l, function (e) {
                          ...
                          if ("string" == typeof i)
                            for (
                              var o = i.split(" "), r = o[o.length - 1], a = 0;
                              a < n;
                              a++
                            )
                              s[t[a]] = o[a] || r;
                          else for (a = 0; a < n; a++) s[t[a]] = i;
                          delete s[e];
                        }),
                          L(e, this._tokenData),
                          L(t, this._tokenData),
                ...
                (i.prototype.value = function () {
                  ...
                  (i.prototype.animate = function (e, n, t) {
                    ...
                    var i = l.extend({}, n),
                      ...
                      o = ((n = l.extend(o, n)), this._easing(n.easing)),
                      i = this._resolveFromAndTo(e, o, i),
                      r =
                        (this.stop(),
                  ...
                  (i.prototype._initializeTextContainer = function (e, t, n) {
                    e.text.style &&
                      ...
                      e.text.alignToBottom
                        ? a.setStyle(n, "transform", "translate(-50%, 0)")
                        : a.setStyle(n, "transform", "translate(-50%, 50%)"));
                  }),
                  (i.prototype._pathString = r.prototype._pathString),
                  (i.prototype._trailString = r.prototype._trailString),
                  (t.exports = i);
              },
              {
                "./circle": 2,
            ...
            7: [
              function (e, t, n) {
                function i(e, t) {
                  ...
                  if (0 !== arguments.length) {
                    ...
                    (this._container = n),
                      ...
                      this._opts.svgStyle &&
                        r.setStyles(t.svg, this._opts.svgStyle),
                      (this.svg = t.svg),
                      (this.path = t.path),
                      (this.trail = t.trail),
                      (this.text = null);
                    ...
                    (this._progressPath = new o(t.path, e)),
                ...
                (i.prototype.animate = function (e, t, n) {
                  ...
                  (i.prototype._initializeTextContainer = function (
                    e,
                    t,
                    n
                  ) {}),
            ...
            9: [
              function (e, t, n) {
                ...
                function i(e, t, n) {
                  for (var i = e.style, o = 0; o < r.length; ++o)
                    i[r[o] + a(t)] = n;
                  i[t] = n;
                }
                function a(e) {
      ...
      E =
        ((O.getInstance = function (e) {
          if (!O.instance) {
            if (!e)
              throw new Error(
                "Can not create new SplashLoader instance without options!"
              );
            O.instance = new O(e);
          }
          return O.instance;
        ...
        (O.prototype.create = function () {
          return c(this, void 0, void 0, function () {
            ...
            return u(this, function (e) {
              switch (e.label) {
                case 0:
                  return [4, this.loadLibs()];
                case 1:
                  return e.sent(), [4, D.loadHost()];
                case 2:
            ...
            return u(this, function (e) {
              switch (e.label) {
                ...
                case 1:
                  return (
                    e.sent(),
                    (t = document.getElementById("h5branding-background")) &&
                      (t.style.backgroundColor = _.brandingBackgroundColor),
                    (t = document.getElementById("h5branding-logo")) &&
                      D.getBrandingDomain() !== r.BrandingDomain.Neutral &&
                      (((n = document.createElement("img")).src =
                        _.brandingLogoUrl.replace("_small", "")),
                      t.appendChild(n)),
                    [2]
                  );
              }
        ...
        (O.prototype.showBanner = function () {
          ...
          return this.bannerAllowed &&
            (e = document.getElementById("h5branding-ad"))
            ? ((e.style.display = "inline-flex"), e)
            : null;
        }),
        (O.prototype.setScriptloadProgress = function (e, t) {
          this.circleLoader.animate((0.3 * t) / e, null, function () {});
        }),
        (O.prototype.setLoadProgress = function (e) {
          var t,
            n = this;
          this.loaded &&
            (100 == (this.progress = e = 30 + 0.7 * e)
              ? ((t = document.querySelector("#h5branding-button")),
                this.circleLoader.animate(1, null, function () {
                  !D.inGDGameZone() && t && !0 === n.showPlayButton
                    ? (t.style.display = "block")
                    : (!D.inGDGameZone() && !1 !== n.showPlayButton) ||
                      n.onPlayButtonClick();
                }))
    ...
    function C() {}
    (C.updateAeriaIFrameSrc = function () {
      try {
        var e = "pc",
          t =
      ...
      (C.addYMenuListener = function () {
        try {
          var t = document.getElementById("menu-button");
          t.onclick = function () {
            var e = document.getElementById("menu-content");
            "-300px" === e.style.left
              ? ((e.style.left = "0"), (t.style.left = "300px"))
              : ((e.style.left = "-300px"), (t.style.left = "0"));
          };
        } catch (e) {
          console.log("Could not add a listener to button");
        }
      }),
      (C.addYLoginListenerForAeria = function (t) {
        h.isAeria() &&
      ...
      (C.toggleYMenuButtonVisibility = function () {
        var e = h.isAeria();
        document.getElementById("menu-header").style.display = e
          ? "block"
          : "none";
      }),
      (C.onGameLoad = function (e) {
        C.updateAeriaIFrameSrc(),
          C.toggleYMenuButtonVisibility(),
          C.addYLoginListenerForAeria(e),
          C.addYMenuListener();
      }),
      (C.sendScoreEvent = function (e, t, n) {
      ...
      (__WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports) {
        ...
        var EasyGameBox =
          ...
          (function () {
            ...
            EasyGameBox.prototype.trigger = function (
              eventName,
              onCompleteCb,
              score,
              gameData,
      ...
      (__WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports) {
        ...
        var GenericHandler =
          ...
          (function () {
            ...
            GenericHandler.prototype.trigger = function (
              eventName,
              onCompleteCb,
              args
            ) {
