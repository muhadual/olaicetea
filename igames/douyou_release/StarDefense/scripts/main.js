    ...
    window.RuntimeInterface = class RuntimeInterface {
        constructor(opts) {
            ...
            if (this.IsAnyWebView2Wrapper())
                self["chrome"]["webview"].addEventListener("message", e => this._OnWrapperMessage(e.data));
    ...
    const HANDLER_CLASS = class RuntimeDOMHandler extends self.DOMHandler {
        ...
        _OnKeyEvent(name, e) {
            ...
            if (this._iRuntime.IsAnyWebView2Wrapper()) {
                ...
                if (blockKeys.includes(e.key) || e.ctrlKey && blockKeysWithCtrl.includes(e.key))
                    e.preventDefault()
            }
            if (this._isExportToVideo)
                return;
    ...
    const HANDLER_CLASS = class BrowserDOMHandler extends self.DOMHandler {
        ...
        _OnNavigate(e) {
            ...
            if (type === "back")
                ...
                else if (exportType === "preview" || this._iRuntime.IsAnyWebView2Wrapper())
