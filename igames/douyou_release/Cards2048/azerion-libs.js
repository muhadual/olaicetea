...
var _azerionIntegration = {
    "gdId": "5370293cd9434e4abe9084397f091ed6",
    "rtgEnabled": false,
    "lbEnabled": false,
    "fbType": "dummy",
    "alxType": "none",
    ...
    "build": {
        "version": "tc-2",
        "timeStamp": 1720529267993,
        "h": "09071c1d"
    },
    "p": "gd",
    "lng": null,
    "gmoEnabled": false,
    "gameTitle": "Cards 2048"
};
var playBtn = true;
var fbrqBD = 8;
var fbrqLA = true;
    ...
    var i = {
            ...
            t.prototype.emit = function(e, t, n, i, o, r) {
                ...
                if (l.fn) {
                    ...
                    case 5:
                        ...
                        !0;
                    case 6:
                        return l.fn.call(l.context, t, n, i, o, r),
                        !0
                    }
                    for (h = 1,
            ...
            t.prototype.removeListener = function(e, t, n, i) {
                ...
                if (this._events[e])
                    if (t) {
                        ...
                        if (o.fn)
                            o.fn !== t || i && !o.once || n && o.context !== n || l(this, e);
                        else {
                            for (var r = 0, a = [], s = o.length; r < s; r++)
                                (o[r].fn !== t || i && !o[r].once || n && o[r].context !== n) && a.push(o[r]);
        ...
        474: (e, t, n) => {
            ...
            t = function(e, t, o, n) {
                ...
                (r = i = t.GameDistributionAdType || (t.GameDistributionAdType = {})).interstitial = "interstitial",
                r.rewarded = "rewarded",
                r.display = "display",
                ...
                a.prototype.showAd = function(t) {
                    ...
                    this.adManager.emit(o.AdEvents.CONTENT_RESUMED)) : window.wsdk.showAd(t === o.AdType.rewarded ? i.rewarded : i.interstitial).catch(function(e) {
                        t === o.AdType.rewarded && n.hasRewarded && (n.hasRewarded = !1),
        ...
        444: (e, t, n) => {
            ...
            t = function(e, t, n, i) {
                ...
                o.prototype.loadBanner = function() {
                    return void 0 === window.wsdk ? Promise.reject("GD Sdk not available, probably due to adblocker") : window.wsdk.showAd(n.GameDistributionAdType.display, {
        ...
        548: function(e, t, n) {
            ...
            , n = [n, t, n(34), n(12), n(563), n(766)], t = function(e, t, n, i, o, r) {
                var a;
                function s(e, t) {
...
function(e, t) {
    ...
    e(function(e, I) {
        ...
        function d(e, t) {
            var n, i = this, o = new this.constructor(u), r = (void 0 === o[O] && y(o),
            i._state);
        ...
        function h(e, t, n) {
            ...
            (o = t)._state === B ? f(i, o._result) : o._state === L ? g(i, o._result) : a(o, void 0, function(e) {
                return p(i, e)
            }, function(e) {
                return g(i, e)
        ...
        function m(e, t, n, i) {
            ...
            if (o) {
                ...
                r = i;
            t._state === C && (o && s ? p(t, r) : !1 === s ? g(t, a) : e === B ? f(t, r) : e === L && g(t, r))
        }
        function y(e) {
            e[O] = R++,
            e._state = void 0,
        ...
        var w, r, v, b, _, A, x, D, S, T, k, P, E, O, C, B, L, R, F, M;
        ...
        i.prototype._eachEntry = function(t, e) {
            ...
            if (i === c) {
                ...
                r === d && t._state !== C ? this._settledAt(t._state, e, t._result) : "function" != typeof r ? (this._remaining--,
                this._result[e] = t) : n === M ? (o = new n(u),
                s ? g(o, a) : h(o, t, r),
                this._willSettleAt(o, e)) : this._willSettleAt(new n(function(e) {
                    return e(t)
                }
                ), e)
            } else
    ...
    t.has = function(e) {
        ...
        return !(i <= 0 || i >= e.length - 1 || (t = e.lastIndexOf(".", i - 1)) <= 0 || i - 1 <= t || !(n = o[e.slice(i + 1)])) && 0 <= n.indexOf(" " + e.slice(t + 1, i) + " ")
    }
    ,
    t.is = function(e) {
        var t, n = e.lastIndexOf(".");
        return !(n <= 0 || n >= e.length - 1 || 0 <= e.lastIndexOf(".", n - 1) || !(t = o[e.slice(n + 1)])) && 0 <= t.indexOf(" " + e.slice(0, n) + " ")
    }
    ,
    t.get = function(e) {
        var t, n, i = e.lastIndexOf(".");
        return i <= 0 || i >= e.length - 1 || (t = e.lastIndexOf(".", i - 1)) <= 0 || i - 1 <= t || !(n = o[e.slice(i + 1)]) || n.indexOf(" " + e.slice(t + 1, i) + " ") < 0 ? null : e.slice(t + 1)
    }
    ;
    var o, n = t;
    function t() {}
    ...
    a.getDomain = function(e) {
        var t;
        return o ? (t = e.match(/\./g)) && t.length < 2 ? e : (t = this.getTld(e)) ? (t = e.length - t.length - 1,
    ...
    d.prototype.requestXhr = function(n, i) {
        ...
        new Promise(function(e, t) {
            o.onreadystatechange = function() {
                ...
                o.onreadystatechange = null) : 0 < o.status && (t("There was a problem with the request: status ".concat(o.status)),
    ...
    (P = r.BrandingDomain || (r.BrandingDomain = {}))[P.Neutral = 0] = "Neutral",
    P[P.Yepi = 1] = "Yepi",
    P[P.Spele = 2] = "Spele",
    ...
    function p() {}
    r.UtmTargets = void 0,
    (P = r.UtmTargets || (r.UtmTargets = {}))[P.splashscreen = 0] = "splashscreen",
    P[P.logo = 1] = "logo",
    ...
    g.getPromoURL = function(e, t, n, i, o) {
        return window.hasOwnProperty("_YaSDK") || window.hasOwnProperty("YaGames") ? "https://".concat(h.getYandexBaseURL(), "/games/developer?name=Azerion") : e === r.BrandingDomain.Admeen ? "https://media.admeen.com/branding/link.php" : e === r.BrandingDomain.Bild ? t : t + "/?utm_source=" + n + "&utm_medium=html5&utm_term=" + i + "&utm_content=" + o + "&utm_campaign=Gamedistribution"
    }
    ;
    var f = g;
    function g() {}
    ...
    b.getDomainForCustomBuild = function() {
        var e;
        return null != (e = window._azerionIntegration) && e.bd && (null == (e = window._azerionIntegration) ? void 0 : e.bd)in r.BrandingDomain ? null == (e = window._azerionIntegration) ? void 0 : e.bd : window.hasOwnProperty("fbrqBD") && window.fbrqBD in r.BrandingDomain ? window.fbrqBD : void 0
    }
    ,
        ...
        return c(this, void 0, void 0, function() {
            ...
            return u(this, function(e) {
                ...
                case 0:
                    ...
                    !window.hasOwnProperty("wsdk"))
                        return [3, 4];
                    e.label = 1;
                case 1:
                    return e.trys.push([1, 3, , 4]),
                    [4, window.wsdk.getSession()];
                case 2:
                    return n = e.sent(),
    ...
    var k = e(function(e, t) {
        e.exports = function n(i, o, r) {
            ...
            for (var s = l, e = 0; e < r.length; e++)
                a(r[e]);
            return a
        }({
            1: [function(e, j, G) {
                !function() {
                    var c, n, u, h, p, e, f, s, d, l, g, r, o, a, i, m, t, y, w = this || Function("return this")(), v = (e = Date.now || function() {
                        return +new Date
                    }
                    ,
                    ...
                    E.prototype.setConfig = function(e) {
                        ...
                        var t = this
                          , n = (this._timeoutHandler = function() {
                            k(t, t._timestamp, t._delay, t._duration, t._currentState, t._originalState, t._targetState, t._easing, t._step, t._scheduleFunction)
                        }
                        ,
                        this._currentState)
                          , i = this._targetState;
                        return x(i, n),
                        this._easing = P(n, e.easing || "linear"),
                    ...
                    E.prototype.seek = function(e) {
                        ...
                        this._isPaused = !1,
                        k(this, this._timestamp, this._delay, this._duration, this._currentState, this._originalState, this._targetState, this._easing, this._step, this._scheduleFunction, t),
                        this.pause()),
                        this
                    }
                    ,
                    ...
                    "function" == typeof SHIFTY_DEBUG_NOW && (w.timeoutHandler = k),
                    "object" == typeof G ? j.exports = E : void 0 === w.Tweenable && (w.Tweenable = E),
                    E);
                    function b() {}
                    function _(e, t) {
                        for (var n in e)
                    ...
                    function k(e, t, n, i, o, r, a, s, l, d, c) {
                        ...
                        T(e, "beforeTween"),
                        u < t + n ? D(1, o, r, a, 1, 1, s) : D(u, o, r, a, i, t + n, s),
                        T(e, "afterTween"),
                        l(o, e._attachment, p)))
                    }
                    function P(e, t) {
                    ...
                    function z(e) {
                        for (var t = e.match(r), n = t.length, i = e.match(a)[0], o = 0; o < n; o++)
                            i += parseInt(t[o], 10) + ",";
                        return i.slice(0, -1) + ")"
                    }
                    function L(o, r) {
                        d.each(r, function(e) {
                            for (var t = M(o[e]), n = t.length, i = 0; i < n; i++)
                    ...
                    v.setBezierFunction = function(e, t, n, i, o) {
                        function r(e) {
                            return c = (o = 1) - (h = 3 * (t = a)) - (u = 3 * ((n = p) - a) - h),
                        ...
                        beforeTween: function(e, t, n, i) {
                            ...
                            d.each(l, function(e) {
                                var t = l[e].chunkNames
                                  ...
                                  , i = s[e];
                                if ("string" == typeof i)
                                    for (var o = i.split(" "), r = o[o.length - 1], a = 0; a < n; a++)
                                        s[t[a]] = o[a] || r;
                                else
                                    for (a = 0; a < n; a++)
                                        s[t[a]] = i;
            ...
            2: [function(e, t, n) {
                ...
                var o = e("./shape")
                  , r = e("./utils");
                ((i.prototype = new o).constructor = i).prototype._pathString = function(e) {
                    var t = e.strokeWidth
            ...
            3: [function(e, t, n) {
                ...
                var o = e("./shape")
                  , r = e("./utils");
                ((i.prototype = new o).constructor = i).prototype._initializeSvg = function(e, t) {
            ...
            7: [function(e, t, n) {
                function i(e, t) {
                    ...
                    if (0 !== arguments.length) {
                        ...
                        r.isObject(t) && void 0 !== t.svgStyle && (this._opts.svgStyle = t.svgStyle),
                        r.isObject(t) && r.isObject(t.text) && void 0 !== t.text.style && (this._opts.text.style = t.text.style);
                        ...
                        this._opts.svgStyle && r.setStyles(t.svg, this._opts.svgStyle),
                        this.svg = t.svg,
                        this.path = t.path,
                        this.trail = t.trail,
                        this.text = null;
                ...
                i.prototype.setText = function(e) {
                    ...
                    r.isObject(e) ? (r.removeChildren(this.text),
                ...
                i.prototype._warnContainerAspectRatio = function(e) {
                    ...
                    r.floatEquals(this.containerAspectRatio, n / i) || (console.warn("Incorrect aspect ratio of container", "#" + e.id, "detected:", t.getPropertyValue("width") + "(width)", "/", t.getPropertyValue("height") + "(height)", "=", n / i),
        ...
        return c(this, void 0, void 0, function() {
            ...
            return u(this, function(e) {
                ...
                case 0:
                    ...
                    o.id = "h5branding-container",
                    (r = document.body || document.getElementsByTagName("body")[0]).insertBefore(o, r.firstChild),
                    this.circleLoader = new k.Circle("#h5branding-bar",{
                        strokeWidth: 3,
        ...
        return c(this, void 0, void 0, function() {
            ...
            return u(this, function(e) {
                ...
                case 1:
                    ...
                    (t = document.getElementById("h5branding-logo")) && x.getBrandingDomain() !== r.BrandingDomain.Neutral && ((n = document.createElement("img")).src = _.brandingLogoUrl.replace("_small", ""),
                    t.appendChild(n)),
                    [2]
                }
            })
    ...
    ,
    E.prototype.setScriptloadProgress = function(e, t) {
        this.circleLoader.animate(.3 * t / e, null, function() {})
    }
    ,
    E.prototype.setLoadProgress = function(e) {
        var t, n = this;
    ...
    ,
    E.prototype.setButtonCallback = function(e) {
    ...
    function O() {}
    O.updateAeriaIFrameSrc = function() {
        try {
            var e = "pc"
    ...
    ,
    O.addYLoginListenerForAeria = function(t) {
        h.isAeria() && window.addEventListener("message", function(e) {
            "resultBoxClosed" === e.data.action && t()
        }, !1)
    }
    ,
    O.toggleYMenuButtonVisibility = function() {
        var e = h.isAeria();
        document.getElementById("menu-header").style.display = e ? "block" : "none"
    }
    ,
    O.onGameLoad = function(e) {
        O.updateAeriaIFrameSrc(),
        O.toggleYMenuButtonVisibility(),
        O.addYLoginListenerForAeria(e),
        O.addYMenuListener()
    }
    ,
    O.sendScoreEvent = function(e, t, n) {
        if (h.isAeria() && window.hasOwnProperty("wsdk")) {
...
( () => {
    ...
    var __webpack_modules__ = ({
        ...
        ( (module, exports, __webpack_require__) => {
            ...
            var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;
            !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(40), __webpack_require__(810)],
            __WEBPACK_AMD_DEFINE_RESULT__ = (function(require, exports, EasyGameBox_1, GenericHandler_1) {
                "use strict";
                Object.defineProperty(exports, "__esModule", ({
                    value: true
                }));
