...
FullscreenImage.attributes.add("stretch", {
  ...
  (FullscreenImage.prototype.initialize = function () {
    (this.nullRes = new pc.Vec2(
      ...
      (this.previousReferenceResolution =
        this.screenComponent.referenceResolution.clone()),
      this.updateSize(),
  ...
  (FullscreenImage.prototype.update = function (e) {
    this.screenComponent.referenceResolution.equals(
      this.previousReferenceResolution
    ) ||
      (this.previousReferenceResolution.copy(
        this.screenComponent.referenceResolution
      ),
      this.updateSize());
  });
var sdkHandler,
...
(Game.tempPos = new pc.Vec3()),
  ...
  (Game.prototype.initialize = function () {
    ...
    (this.currScore = 0),
      ...
      (Input.mouseDis = !0),
      Game.testAPI
        ? ((this.currLevel = 2), this.initialize2())
        : initializeGame();
  }),
  ...
  (Game.prototype.loadLevel = function () {
    ...
    this.finish.setPosition(this.lastPos.x + 5.5, 5, 0),
      Game.testAPI && this.finish.setPosition(a.x + 15.5, a.y, 0),
      this.finish.script.finishController.placeBlocks2(this.bonusReady);
    for (var n = 0; n < this.finish.children.length; n++)
      (t = this.finish.children[n]).script &&
        t.script.collBox &&
  ...
  (Game.prototype.addLevel = function (e) {
    ...
    if ((t.removeChild(o), 0 == this.addedLevelsCount))
      ...
      for (var h, d, c = 0; c < t.children.length; c++)
        if ((h = t.children[c]).enabled && "Ground" == h.name) {
          var m = h.getPosition();
          (d = m.y + h.getLocalScale().y / 2) > this.levelUpperPlank &&
            (this.levelUpperPlank = d),
    ...
    for (c = 0; c < t.children.length; c++)
      if ((h = t.children[c]).enabled && !h.script)
        for (var p = h.children.length - 1; p >= 0; p--)
          EntityTools.reparent(h.children[p], t);
    for (c = 0; c < t.children.length; c++)
      (h = t.children[c]).script && h.script.collBox && h.script.collBox.init(),
        h.tags.has("deadzone") && (h.render.enabled = !1);
    for (c = 0; c < t.children.length; c++) {
      (h = t.children[c]).script &&
        h.script.physScaler &&
  ...
  (Game.prototype.onLevelCompleted = function (e) {
    ...
    (Game.state = Game.STATE_LEVELCOMPLETED),
      ...
      null != Game.instance.bonusOperator
        ? (50 == Game.instance.bonusMultiplier &&
            sdkHandler &&
            sdkHandler.celebrateHappyTime(),
        ...
        : (this.currLevel++,
          ...
          FadeScreen.instance.show(0.3, 2, 0, function () {
            (Game.instance.uiCompleted.enabled = !0),
              sdkHandler && sdkHandler.requestAd("midgame", null);
          }),
          this.saveGame());
  }),
  ...
  (Game.prototype.update = function (e) {
    if (
      ...
      (n.yaw = pc.math.lerp(-42, -25, pc.math.clamp((t - a) / a, 0, 1))),
        (n.distance = pc.math.lerp(20, 15, pc.math.clamp((t - a) / a, 0, 1)));
    }
    Game.noDebug ||
  ...
  (Gui.buttonAction = function (e, a) {
    switch (e) {
      ...
      case "ShopMoneyForReward":
        // sdkHandler && sdkHandler.requestAd("rewarded", ( () => {
        //     console.log("Rewarded ad was successful, granting reward..."),
...
(Knife.tempVec = new pc.Vec3()),
  ...
  Knife.attributes.add("customStickPoint", {
    type: "boolean",
    default: !1,
  }),
  (Knife.instance = null),
  (Knife.prototype.initialize = function () {
    (Knife.instance = this),
      ...
      this.customStickPoint
        ? (this.stickPoint = this.entity.findByName("StickPoint"))
        : (this.stickPoint = this.entity.findByName("Trail1")),
  ...
  (Knife.prototype.stuck = function (t = !1) {
    this.vel.set(0, 0, 0),
      ...
      this.lastStuckPos ||
        ((this.lastStuckPos = new pc.Vec3()),
        (this.lastStuckAngles = new pc.Vec3(0, 0, 0))),
      ((!this.bladeC.checkIfUnderLine(2) && !this.bodyC.checkIfUnderLine(2)) ||
        t) &&
  ...
  (Knife.prototype.onBladeTriggerEnter = function (t) {
    ...
    if (e.tags.has("ground") && 1 == this.state) {
      if (
        ...
        s &&
          s.count > 1 &&
          (s = FinishController.instance.findBlockByPosition(
            this.stickPoint.getPosition()
          )),
          s
            ? ((i = s.entity),
              (Game.instance.bonusOperator =
                FinishController.instance.getBlockOperator(s.entity)))
            : ((i = e), (Game.instance.bonusOperator = null));
        var n = !1;
        (Game.instance.bonusMultiplier = 1),
          Game.instance.bonusOperator &&
            s &&
            (Game.instance.bonusMultiplier = s.count),
          Game.instance.bonusOperator
            ? 50 == s.count && Game.instance.bonusReady
              ? (GameAudio.play("bonushit"), (n = !0))
              : GameAudio.play("xhit")
            : GameAudio.play("finishhit"),
          s && console.log(s),
          console.log(n),
          Game.instance.onLevelCompleted(n);
    ...
    if (e.tags.has("sliceable")) {
      ...
      var l = 0;
      a.complexSlice && (l = (this.bladeC.pos.z - t.pos.z) / t.zSize + 0.5),
        a.slice(l),
        (this.sliceCd = 0.1),
        this.vel.x > 0 &&
  ...
  (Sliceable.prototype.slice = function (t) {
    ...
    if (
      ...
      (l = Game.bonusLevel
        ...
        : Game.instance.whiteColor),
      Game.instance.showText(r, n.x, n.y, l, 1, c),
...
FinishController.attributes.add("blocks", {
  ...
  (FinishController.prototype.setBestBlockType = function () {
    for (
      var t, e, o = 0;
      o < FinishController.blockData.length &&
      50 != (t = FinishController.blockData[o]).count;
      o++
    );
    var r,
      l,
    ...
    for (o = 1; o < FinishController.blockData.length; o++)
      (l = FinishController.blockData[o].blockType),
        (r = this.applyOperatorData(100, l)) > a &&
          ((a = r), (i = l), (e = FinishController.blockData[o]));
  ...
  (FinishController.prototype.placeBlocks2 = function (t) {
    ...
    for (var i, a, n = 0, s = 0; s < this.blocks.length; s++) {
      ...
      for (var p = 0; p < FinishController.blockData.length; p++)
        2 == (e = FinishController.blockData[p]).count && e.entity,
          l == e.entity && ((e.blockType = this.blockTypes[n]), n++);
    }
    MathUtil.shuffleArray(FinishController.blockData),
      ((o = this.blocks[0].getLocalPosition().clone()).y = 0),
      (r = this.textEntity.getLocalPosition().clone());
    for (p = 0; p < FinishController.blockData.length; p++)
      (a = (e = FinishController.blockData[p]).blockType),
        50 == e.count && (i = e),
        (e.text.element.text = a.text),
        (o.y += 0.5 * e.sizeY),
        e.entity.setLocalPosition(o.x, o.y, o.z),
        e.text.setLocalPosition(r.x, o.y, r.z),
        (o.y += 0.5 * e.sizeY);
    t
      ? ((i.text.element.text = "BONUS!"), (i.text.script.scaler.enabled = !0))
      : ((i.text.script.scaler.enabled = !1),
        i.text.setLocalScale(0.01, 0.01, 0.01)),
      (o.y += 0.5 * this.lastBlockSizeY),
      this.lastBlock.setLocalPosition(o.x, o.y, o.z);
  });
var OperatorType = {
  ADD: {
    symbol: "+",
...
(FinishController.prototype.generateRandomBlockData = function () {
  (this.blockTypes = []),
    ...
    this.blockTypes.push(this.createBlock(OperatorType.MULTIPLY)),
    this.blockTypes.push(this.createBlock(OperatorType.MULTIPLY)),
    this.blockTypes.sort((t, e) => t.weight - e.weight);
}),
  (FinishController.prototype.generateRandomBlockData2 = function () {
    ...
    (t =
      ...
      this.blockTypes.push(this.createBlock(e)),
  ...
  (FinishController.prototype.beautifyNumber = function (t, e) {
    ...
    if (t < 5)
      (o = Math.max(t, 2)),
        (e != OperatorType.ADD && e != OperatorType.SUBTRACT) || (o = 5);
    else if (t <= 10)
      o =
        e == OperatorType.ADD || e == OperatorType.SUBTRACT
  ...
  (FinishController.prototype.applyOperatorData = function (t, e) {
    var o = t;
    return (
      e.operator == OperatorType.MULTIPLY
        ? (o *= e.value)
        : e.operator == OperatorType.DIVIDE
        ? (o /= e.value)
        : e.operator == OperatorType.ADD
        ? (o += e.value)
        : e.operator == OperatorType.SUBTRACT && (o -= e.value),
      Math.round(o)
    );
  }),
  (FinishController.prototype.generateBlockText = function (t, e) {
    ...
    return (
      e == OperatorType.MULTIPLY
        ? (o = "x " + t.toString())
        : e == OperatorType.DIVIDE
        ? (o = "÷ " + t.toString())
        : e == OperatorType.ADD
        ? (o = "+ " + t.toString())
        : e == OperatorType.SUBTRACT && (o = "- " + t.toString()),
      o
    );
  }),
  (FinishController.prototype.initialize = function () {
    ...
    for (
      var t, e, o = [2, 3, 5, 10, 25, 50], r = 0;
      r < this.blocks.length;
      r++
    )
      ((t = this.textEntity.clone()).element.text = o[r].toString() + " x"),
        this.entity.addChild(t),
        (e = this.blocks[r].getLocalScale().y),
  ...
  (FinishController.prototype.getBlockData = function (t) {
    for (var e, o = 0; o < FinishController.blockData.length; o++)
      if ((e = FinishController.blockData[o]).entity == t) return e;
    return null;
  }),
  ...
  (FinishController.prototype.getBlockOperator = function (t) {
    for (var e, o = 0; o < FinishController.blockData.length; o++)
      if ((e = FinishController.blockData[o]).entity == t) return e.blockType;
    return null;
  }),
  (FinishController.prototype.placeBlocks = function (t) {
    ...
    (this.flag.enabled = !1),
      ...
      ((o = this.blocks[0].getLocalPosition().clone()).y = 0),
      (r = this.textEntity.getLocalPosition().clone());
    for (var i = 0; i < FinishController.blockData.length; i++)
      50 == (e = FinishController.blockData[i]).count && (l = e),
        (o.y += 0.5 * e.sizeY),
        e.entity.setLocalPosition(o.x, o.y, o.z),
        e.text.setLocalPosition(r.x, o.y, r.z),
        (o.y += 0.5 * e.sizeY);
  ...
  (FinishController.prototype.showFlag = function () {
    setTimeout(function () {
      ...
      for (
        var t = FinishController.instance.entity.getPosition(), e = 0;
        e < 59;
        e++
      )
        Serpantine.create(t);
...
ShopController.attributes.add("rewButton", {
  ...
  (ShopController.prototype.initialize = function () {
    ...
    (this.initialHeight = r.referenceResolution.y),
      this.onEnable(),
      this.on("enable", this.onEnable, this),
      (this.unlocking = !1),
      (this.unlockSteps = 0),
  ...
  (ShopController.prototype.onEnable = function () {
    ...
    window.innerHeight > window.innerWidth
      ? ((t.referenceResolution.y = this.initialHeight + 170),
        (t.resolution = new pc.Vec2(
          t.referenceResolution.x,
          t.referenceResolution.y
        )))
      : ((t.referenceResolution.y = this.initialHeight),
        (t.resolution = new pc.Vec2(
          t.referenceResolution.x,
          t.referenceResolution.y
        ))),
...
(UiInterface.instance = null),
  (UiInterface.prototype.initialize = function () {
    ...
    (this.initialHeight = e.referenceResolution.y),
      this.onEnable(),
      this.on("enable", this.onEnable, this);
  }),
  (UiInterface.prototype.onEnable = function () {
    var e = this.entity.screen;
    window.innerHeight > window.innerWidth
      ? ((e.referenceResolution.y = this.initialHeight + 170),
        (e.resolution = new pc.Vec2(
          e.referenceResolution.x,
          e.referenceResolution.y
        )))
      : ((e.referenceResolution.y = this.initialHeight),
        (e.resolution = new pc.Vec2(
          e.referenceResolution.x,
          e.referenceResolution.y
        ))),
      console.log(e.referenceResolution.y),
      ...
      this.swingDirection > 0
        ? ((this.elapsedTime += e),
          this.elapsedTime >= this.time &&
            ((this.elapsedTime = this.time), (this.swingDirection = -1)))
        : ((this.elapsedTime -= e),
          this.elapsedTime <= 0 &&
            ((this.elapsedTime = 0), (this.swingDirection = 1)));
      var t,
...
UiCompleted.attributes.add("textColors", {
  ...
  UiCompleted.attributes.add("bonusColors", {
    type: "rgba",
    array: !0,
  }),
  ...
  (UiCompleted.prototype.createSerpentines = function (e, t, n) {
    for (var i = 0; i < e; i++) {
      ...
      (l = pc.math.random(-3, 3)),
        ...
        o.script.uiSerpantine.init(),
        (o.script.uiSerpantine.velocity.x = l),
        (o.script.uiSerpantine.velocity.y = c),
        this.entity.addChild(o),
        o.setLocalPosition(s, a, r),
        this.serps.push(o);
    }
  }),
  (UiCompleted.prototype.initialize = function () {
    (this.serps = []),
      ...
      (this.totalUpper = this.entity.findByName("totalupper")),
      (this.best = this.entity.findByName("best")),
  ...
  (UiCompleted.prototype.onEnableCb = function () {
    ...
    for (
      window.innerHeight > window.innerWidth
        ...
        this.countingTotalResultBest = !1,
        this.prevBestScore = Game.instance.bestScore,
        Game.instance.bestScore < Game.instance.totalEarned &&
          (Game.instance.bestScore = Game.instance.totalEarned);
      this.serps.length > 0;
  ...
  (UiCompleted.prototype.update = function (e) {
    if (
      (this.countingTotal &&
        (this.total.script.counterText.shownValue > this.prevBestScore &&
          (this.countingTotalResultBest ||
            ((this.total.element.color = this.bonusColors[1]),
            (this.totalUpper.element.color = this.bonusColors[1]),
            (this.countingTotalResultBest = !0))),
        this.countingTotalResultBest &&
          (this.best.element.text =
            this.total.script.counterText.shownValue.toString())),
      this.counterId > 3)
    )
      return 1;
    (this.counterTimer += e),
      ...
      this.alpha < 0 &&
        (this.beta <= 0
          ? ((this.tm2 = this.app.root.findByName("uiOverlay")),
            ...
            (this.l.enabled = !0),
            Game.instance.pause(!0))
          : ((this.alpha = 60 + e), this.beta--));
    var t = Math.floor(this.alpha);
    this.tm.text =
      t >= 10
        ? this.beta.toString() + ":" + t.toString()
        : this.beta.toString() + ":0" + t.toString();
  });
    ...
    this.sdktype == e &&
      (this.sdktype == Sdkmanager.SDK_CRAZYGAMES
        ? "gameplayStart" == t
          ...
          : "happytime" == t && this.crazysdk.happytime()
        : this.sdktype == Sdkmanager.SDK_COOLMATH &&
          ("start" == t
            ? window.self != window.top
              ? parent.cmgGameEvent && parent.cmgGameEvent("start")
              : window.cmgGameEvent && window.cmgGameEvent("start")
            : "startLevel" == t
            ? window.self != window.top
              ? parent.cmgGameEvent && parent.cmgGameEvent("start", String(a))
              : window.cmgGameEvent && window.cmgGameEvent("start", String(a))
            : "replayLevel" == t &&
              (window.self != window.top
                ? parent.cmgGameEvent &&
                  parent.cmgGameEvent("replay", String(a))
                : window.cmgGameEvent &&
                  window.cmgGameEvent("replay", String(a)))));
  }),
...
class CrazyGamesSDKHandler {
  ...
  async getUserData() {
    if (this.sdkLoaded)
      try {
        ...
        return console.log("User data:", e), e;
      } catch (e) {
        console.error("Get user error:", e);
      }
    else console.error("SDK is not initialized.");
  }
  ...
  checkEnvironment() {
    this.sdkLoaded
      ? console.log("Current environment:", window.CrazyGames.SDK.environment)
      : console.error("SDK is not initialized.");
  }
  isQATool() {
    if (this.sdkLoaded) return window.CrazyGames.SDK.isQaTool;
    console.error("SDK is not initialized.");
  }
  async requestAd(e, a) {
    if (!this.sdkLoaded) return void console.error("SDK is not initialized.");
    const o = {
      adFinished: () => {
        console.log(`End ${e} ad`),
          this.resumeGame(),
          "function" == typeof a && a();
      },
      adError: (a) => {
        console.log(`Error ${e} ad`, a), this.resumeGame();
      },
      adStarted: () => {
        console.log(`Start ${e} ad`), this.pauseGame();
      },
    };
    window.CrazyGames.SDK.ad.requestAd(e, o);
  }
  async detectAdblock() {
    if (!this.sdkLoaded) return void console.error("SDK is not initialized.");
    const e = await window.CrazyGames.SDK.ad.hasAdblock();
    console.log("Adblock usage fetched", e);
  }
  pauseGame() {
    console.log("Game paused, audio muted."),
      (this.muteSoundState = GameAudio.mute),
      (this.muteMusicState = GameAudio.muteMus),
      GameAudio.switch(!0),
      GameAudio.switchMusic(!0);
  }
  resumeGame() {
    console.log("Game resumed, audio unmuted."),
      GameAudio.switch(this.muteSoundState),
      GameAudio.switchMusic(this.muteMusicState);
  }
  gameplayStop() {
    console.log("gameplayStop"), window.CrazyGames.SDK.game.gameplayStop();
  }
  gameplayStart() {
    console.log("gameplayStart"), window.CrazyGames.SDK.game.gameplayStart();
  }
  celebrateHappyTime() {
    this.sdkLoaded
...
pc.script.createLoadingScreen(function (S) {
  ...
  !(function dg_createHTMLElements() {
    ...
    (l.id = "rotatingImagesContainer"),
      (l.style.position = "absolute"),
      (l.style.top = "80%"),
      (l.style.left = "50%"),
      (l.style.transform = "translate(-50%, -50%)"),
      (l.style.height = 0.038 * window.innerHeight + "px"),
      ...
      Date.now(),
        (J = setInterval(() => {
          !(function animate(S) {
            ...
            J &&
              ((A += (k - A) * S * 1),
              (J.style.clipPath = `inset(0 ${100 - A}% 0 0)`));
          })(1 / 60);
        }, 16.666666666666668));
    })();
});
var TextIcon2 = pc.createScript("textIcon2");
TextIcon2.attributes.add("icon", {
  type: "entity",
}),
  TextIcon2.attributes.add("spacing", {
    type: "number",
    default: 20,
    title: "icon spacing",
  }),
  TextIcon2.attributes.add("yspacing", {
    type: "number",
    default: 0,
    title: "icon y-spacing",
  }),
  TextIcon2.attributes.add("leftside", {
    type: "boolean",
    default: !0,
    title: "left side icon",
  }),
  TextIcon2.attributes.add("lerpTime", {
    type: "number",
    default: 1,
    title: "lerp speed",
  }),
